        ...
        <div class="row justify-content-center">
            <div class="col-lg-10 text-center">
                ...
                <div class="bannar-content">
                    <span class="hero-subtitle-pill"><?php echo e(get_settings('system_title')); ?></span>
                    <h2><?php echo e(get_settings('banner_title')); ?></h2>
                    <p class="hero-description"><?php echo e(get_settings('banner_subtitle')); ?></p>
                    
                    <div class="hero-cta-buttons mt-5 d-flex justify-content-center align-items-center gap-3">
                        <a href="<?php echo e(route('login')); ?>" class="hero-btn-primary"><?php echo e(get_phrase('Get Started')); ?> <i class="fa-solid fa-arrow-right ms-2"></i></a>
                        <a href="#feature" class="hero-btn-secondary"><?php echo e(get_phrase('Explore Features')); ?></a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('frontend.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\schage\resources\views/frontend/landing_page.blade.php ENDPATH**/ ?>